...
Desky jsou vyrobené z izolačních materiálů s pájecími poli, kterým se říká podložky a elektrickými spoji nazývanými stopy.\citace{PCB deska}
...
\clearpage
\obrazek{reed_switch}{Magnetický spínač}{5cm}{reedSwitch.png}
...
\literatura{
	...
	\url{Magnetický spínač}{uk.rs-online.com}{reed-switches-guide}{2023}{1. 2. 2023}{https://uk.rs-online.com/web/content/discovery/ideas-and-advice/reed-switches-guide}
