...
char b[] = {22, 19, 21, 23, 20, 21, 19, 22, 28, 21, 16, 13, 12, 13, 16, 21, 18,
            18, 18, 18, 18, 18, 18, 18, 22, 15, 10, 7,  6,  7,  10, 15, 0,  0,
            0,  0,  0,  0,  0,  0,  18, 11, 6,  3,  2,  3,  6,  11, 0,  0,  0,
            0,  0,  0,  0,  0,  16, 9,  4,  1,  0,  1,  4,  9,  0,  0,  0,  0,
            0,  0,  0,  0,  16, 9,  4,  1,  0,  1,  4,  9,  0,  0,  0,  0,  0,
            0,  0,  0,  18, 11, 6,  3,  2,  3,  6,  11, 9,  9,  9,  9,  9,  9,
            9,  9,  22, 15, 10, 7,  6,  7,  10, 15, 14, 11, 13, 15, 12, 13, 11,
            14, 28, 21, 16, 13, 12, 13, 16, 21, 0};
...
short D(short q, short l, short e, unsigned char E, unsigned char z,
        unsigned char n) {
  short m, v, i, P, V, s;
          ...
          do {                         /* y traverses ray, or:     */
            ...
            if (d - !t > 1)        /* remaining depth          */
            {
              ...
              if (p < 3)                    /* pawns:                   */
              {
                ...
                V = y + r + 1 & S
                        ? 647 - p
                        : 2 * (u & y + 16 & 32); /* promotion or 6/7th bonus */
                b[y] += V;
              ...
              do
                s = C > 2 | v > V
                        ? -D(-l, -V, -v, /* recursive eval. of reply */
                             F, 0, C)
...
void AI_HvsC(char move[4]) {
  ...
  Serial.println("AI detected move: ");
  ...
  K = *c - 16 * c[1] + 799, L = c[2] - 16 * c[3] + 799; /* parse entered
  move */
  N = 0;
  ...
  if (k == 0x10) { /* The flag turn must change to 0x08 */
    Serial.println("tohle No valid move");
    return;
  }
